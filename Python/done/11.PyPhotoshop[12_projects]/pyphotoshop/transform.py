...
if __name__ == '__main__':
    ...
    brightened_im.write_image('lake_brightened.png')

    print("darkening")
    darkened_im = brighten(lake, 0.3)
    darkened_im.write_image('lake_darkened.png')

    print("increase contrast")
    incr_contrast = adjust_contrast(lake, 2, 0.5)
    incr_contrast.write_image('lake_increased_contrast.png')

    print("decrease contrast")
    decr_contrast = adjust_contrast(lake, 0.5, 0.5)
    decr_contrast.write_image('lake_decreased_contrast.png')

    print("blur using kernel 3")
    blur_3 = blur(city, 3)
    blur_3.write_image('city_blur_k3.png')

    print("blur using kernel size of 15")
    blur_15 = blur(city, 15)
    blur_15.write_image('city_blur_k15.png')

    print("let's apply a sobel edge detection kernel on the x and y axis")
    ...
    print("let's combine these and make an edge detector!")
